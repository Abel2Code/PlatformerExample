...
public class Levels {
	...
	public static Label[][] firstLevel(){
		Label[][] labels = new Label[][]{
			...
			{labelInit("background"),labelInit("background"),labelInit("background"),labelInit("background"),labelInit("background"),labelInit("background"),labelInit("background"),labelInit("background"),labelInit("background"),labelInit("background"),labelInit("background"),labelInit("background"),labelInit("background"),labelInit("solid")     ,labelInit("background")},
